...
var o__58518__auto___60052 = (function (){var o__58518__auto__ = (function (){var o__58518__auto__ = Promise;
return goog.object.get(o__58518__auto__,"resolve").call(o__58518__auto__);
})();
return goog.object.get(o__58518__auto__,"then").call(o__58518__auto__,callback);
})();
goog.object.get(o__58518__auto___60052,"catch").call(o__58518__auto___60052,devtools.async.rethrow_outside_promise);
...
var G__60054_60055 = Error;
var target__58537__auto___60056 = G__60054_60055;
if(cljs.core.truth_(target__58537__auto___60056)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__60054_60055)].join('')),cljs.core.str("\n"),cljs.core.str("target__58537__auto__")].join('')));
}

goog.object.set(target__58537__auto___60056,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1484940847479