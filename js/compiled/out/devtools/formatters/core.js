...
var and__44485__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__44485__auto__){
var or__44497__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e59762){var e__58543__auto__ = e59762;
return false;
...
}catch (e59764){var e__58543__auto__ = e59764;
return false;
...
}catch (e59770){var e__58543__auto__ = e59770;
return false;
...
}catch (e59772){var e__58543__auto__ = e59772;
return false;
...
}catch (e59778){var e__58543__auto__ = e59778;
return false;
}})())){
...
}catch (e59780){var e__58543__auto__ = e59780;
return false;
}})())){
...
var _STAR_current_state_STAR_59783 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__44497__auto__ = config;
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_59783;
}});
});
...
return (function() { 
var G__59786__delegate = function (args){
...
var G__59786 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59787__i = 0, G__59787__a = new Array(arguments.length -  0);
while (G__59787__i < G__59787__a.length) {G__59787__a[G__59787__i] = arguments[G__59787__i + 0]; ++G__59787__i;}
  args = new cljs.core.IndexedSeq(G__59787__a,0);
} 
return G__59786__delegate.call(this,args);};
G__59786.cljs$lang$maxFixedArity = 0;
G__59786.cljs$lang$applyTo = (function (arglist__59788){
var args = cljs.core.seq(arglist__59788);
return G__59786__delegate(args);
});
...
var pre_handler = (function (){var or__44497__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
var post_handler = (function (){var or__44497__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1484940847058