...
var len__45572__auto___59329 = arguments.length;
var i__45573__auto___59330 = (0);
while(true){
if((i__45573__auto___59330 < len__45572__auto___59329)){
args__45579__auto__.push((arguments[i__45573__auto___59330]));

var G__59331 = (i__45573__auto___59330 + (1));
i__45573__auto___59330 = G__59331;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45580__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq59327){
var G__59328 = cljs.core.first.call(null,seq59327);
var seq59327__$1 = cljs.core.next.call(null,seq59327);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__59328,seq59327__$1);
});
...
return (p1__59332_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1484940846080