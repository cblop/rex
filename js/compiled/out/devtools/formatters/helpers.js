...
var G__59297 = devtools.prefs.pref.call(null,v);
v = G__59297;
continue;
} else {
return v;
...
var and__44485__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__44485__auto__){
var and__44485__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__44497__auto__ = (function (){try{if(!((value == null))){
...
}catch (e59310){var e__58543__auto__ = e59310;
return false;
}})();
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
var or__44497__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e59314){var e__58543__auto__ = e59314;
return false;
}})();
...
}catch (e59316){var e__58543__auto__ = e59316;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__44485__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44485__auto__)){
var and__44485__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__44485__auto____$1){
...
var and__44485__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__44485__auto__)){
...
var or__44497__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
var and__44485__auto__ = (function (){var or__44497__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
var vec__59321 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__59321,(0),null);
var name = cljs.core.nth.call(null,vec__59321,(1),null);
...
var and__44485__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__44485__auto__)){
...
var or__44497__auto__ = typeof value === 'string';
if(or__44497__auto__){
return or__44497__auto__;
} else {
var or__44497__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__59324_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__59324_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484940846029