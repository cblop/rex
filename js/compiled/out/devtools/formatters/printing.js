...
var len__45572__auto___59339 = arguments.length;
var i__45573__auto___59340 = (0);
while(true){
if((i__45573__auto___59340 < len__45572__auto___59339)){
args__45579__auto__.push((arguments[i__45573__auto___59340]));

var G__59341 = (i__45573__auto___59340 + (1));
i__45573__auto___59340 = G__59341;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45580__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq59336){
var G__59337 = cljs.core.first.call(null,seq59336);
var seq59336__$1 = cljs.core.next.call(null,seq59336);
var G__59338 = cljs.core.first.call(null,seq59336__$1);
var seq59336__$2 = cljs.core.next.call(null,seq59336__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__59337,G__59338,seq59336__$2);
});
...
if(cljs.core.truth_((function (){var or__44497__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__45103__auto__,writer__45104__auto__,opt__45105__auto__){
return cljs.core._write.call(null,writer__45104__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__44485__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__44485__auto__){
var or__44497__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__59342_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__59342_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__59351__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__44497__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e59355){var e__58543__auto__ = e59355;
return false;
}})();
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
...
}catch (e59357){var e__58543__auto__ = e59357;
return false;
}}
})())){
...
var _STAR_current_state_STAR_59362 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__59363 = opts;
...
var markup_db = cljs.core.get.call(null,map__59363__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_59362;
}});
...
;
var temp__4655__auto___59368 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___59368)){
var managed_print_level_59369 = temp__4655__auto___59368;
var _STAR_print_level_STAR_59367_59370 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_59369;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_59367_59370,managed_print_level_59369,temp__4655__auto___59368,writer,opts,job_fn){
return (function (p1__59365_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__59365_SHARP_,null);
});})(_STAR_print_level_STAR_59367_59370,managed_print_level_59369,temp__4655__auto___59368,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_59367_59370;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1484940846209