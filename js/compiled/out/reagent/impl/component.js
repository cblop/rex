...
if((i < len)){
var k = (ks[i]);
var G__46061 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__46062 = (i + (1));
m = G__46061;
i = G__46062;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__46066 = c;
var G__46066__$1 = (((G__46066 == null))?null:G__46066.prototype);
if((G__46066__$1 == null)){
return null;
} else {
return (G__46066__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__46070 = c;
var G__46070__$1 = (((G__46070 == null))?null:G__46070.prototype);
if((G__46070__$1 == null)){
return null;
} else {
return (G__46070__$1["render"]);
}
})()));
});
...
while (G__46075__i < G__46075__a.length) {G__46075__a[G__46075__i] = arguments[G__46075__i + 0]; ++G__46075__i;}
  args = new cljs.core.IndexedSeq(G__46075__a,0);
} 
...
var _STAR_current_component_STAR_46079 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_46079;
}});
...
var G__46083 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__46083) {
...
var or__44497__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__46085_46087 = (c["cljsRatom"]);
if((G__46085_46087 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__46085_46087);
}
...
if(cljs.core.truth_((function (){var and__44485__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_46090))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_46091)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_46091))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__44497__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
var render_fun__$1 = (function (){var or__44497__auto__ = render_fun;
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__44497__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
var name__$1 = (function (){var G__46089 = name;
switch (G__46089) {
case "":
...
var G__46094 = o;
(G__46094[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__46100 = (function (){var or__44497__auto__ = (function (){var G__46102 = c;
if((G__46102 == null)){
return null;
} else {
...
return (G__46100["_currentElement"]);
}
})();
var name = (function (){var G__46103 = elem;
var G__46103__$1 = (((G__46103 == null))?null:(G__46103["type"]));
if((G__46103__$1 == null)){
return null;
} else {
return (G__46103__$1["displayName"]);
}
})();
var path = (function (){var G__46104 = elem;
var G__46104__$1 = (((G__46104 == null))?null:(G__46104["_owner"]));
var G__46104__$2 = (((G__46104__$1 == null))?null:reagent$impl$component$component_path.call(null,G__46104__$1));
if((G__46104__$2 == null)){
return null;
} else {
return [cljs.core.str(G__46104__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__44497__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
var G__46106 = c;
var G__46106__$1 = (((G__46106 == null))?null:G__46106.constructor);
if((G__46106__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__46106__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1484940684053