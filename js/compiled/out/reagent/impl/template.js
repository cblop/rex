...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__45103__auto__,writer__45104__auto__,opt__45105__auto__){
return cljs.core._write.call(null,writer__45104__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__46128 = o;
(G__46128[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__46130__i < G__46130__a.length) {G__46130__a[G__46130__i] = arguments[G__46130__i + 0]; ++G__46130__i;}
  args = new cljs.core.IndexedSeq(G__46130__a,0);
} 
...
var args = cljs.core.seq(arglist__46131);
...
if(cljs.core.truth_((function (){var and__44485__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__44485__auto__){
var and__44485__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__46137 = jsprops;
(G__46137["defaultValue"] = value);

(G__46137["onChange"] = ((function (G__46137,v,value,on_change){
return (function (p1__46134_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__46134_SHARP_);
});})(G__46137,v,value,on_change))
);

(G__46137["ref"] = ((function (G__46137,v,value,on_change){
return (function (p1__46135_SHARP_){
return (this$["cljsInputElement"] = p1__46135_SHARP_);
});})(G__46137,v,value,on_change))
);
...
var vec__46144 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__46144,(0),null);
var id = cljs.core.nth.call(null,vec__46144,(1),null);
var class$ = cljs.core.nth.call(null,vec__46144,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___46149 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___46149 == null)){
} else {
var key_46150 = temp__4661__auto___46149;
(jsprops["key"] = key_46150);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__46152 = (new reagent.impl.template.NativeWrapper());
(G__46152["name"] = c);
...
var len__45572__auto___46158 = arguments.length;
var i__45573__auto___46159 = (0);
while(true){
if((i__45573__auto___46159 < len__45572__auto___46158)){
args__45579__auto__.push((arguments[i__45573__auto___46159]));

var G__46160 = (i__45573__auto___46159 + (1));
i__45573__auto___46159 = G__46160;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45580__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq46156){
var G__46157 = cljs.core.first.call(null,seq46156);
var seq46156__$1 = cljs.core.next.call(null,seq46156);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__46157,seq46156__$1);
});
...
break;
default:
var G__46164 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__46164;
continue;
...
var n__45412__auto___46167 = a.length;
var i_46168 = (0);
while(true){
if((i_46168 < n__45412__auto___46167)){
(a[i_46168] = reagent.impl.template.as_element.call(null,(a[i_46168])));

var G__46169 = (i_46168 + (1));
i_46168 = G__46169;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__45412__auto___46170 = a.length;
var i_46171 = (0);
while(true){
if((i_46171 < n__45412__auto___46170)){
var val_46172 = (a[i_46171]);
if((cljs.core.vector_QMARK_.call(null,val_46172)) && ((reagent.impl.template.key_from_vec.call(null,val_46172) == null))){
(o["no-key"] = true);
} else {
}

(a[i_46171] = reagent.impl.template.as_element.call(null,val_46172));

var G__46173 = (i_46171 + (1));
i_46171 = G__46173;
continue;
} else {
}
...
var ctx = ({});
var vec__46177 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__46177,(0),null);
var derefed = cljs.core.nth.call(null,vec__46177,(1),null);
...
var G__46181 = (cljs.core.count.call(null,argv) - first_child);
switch (G__46181) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__46181){
...
//# sourceMappingURL=template.js.map?rel=1484940684249