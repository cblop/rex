...
var vec__48130_48133 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_48134 = cljs.core.nth.call(null,vec__48130_48133,(0),null);
var only_after_48135 = cljs.core.nth.call(null,vec__48130_48133,(1),null);
var db_changed_QMARK__48136 = (cljs.core.some_QMARK_.call(null,only_before_48134)) || (cljs.core.some_QMARK_.call(null,only_after_48135));
if(db_changed_QMARK__48136){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_48134);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_48135);
...
var map__48143 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__48143__$1 = ((((!((map__48143 == null)))?((((map__48143.cljs$lang$protocol_mask$partition0$ & (64))) || (map__48143.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48143):map__48143);
var db = cljs.core.get.call(null,map__48143__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__48143__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__48151 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__48151__$1 = ((((!((map__48151 == null)))?((((map__48151.cljs$lang$protocol_mask$partition0$ & (64))) || (map__48151.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48151):map__48151);
var coeffects = map__48151__$1;
var event = cljs.core.get.call(null,map__48151__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__45572__auto___48154 = arguments.length;
var i__45573__auto___48155 = (0);
while(true){
if((i__45573__auto___48155 < len__45572__auto___48154)){
args__45579__auto__.push((arguments[i__45573__auto___48155]));

var G__48156 = (i__45573__auto___48155 + (1));
i__45573__auto___48155 = G__48156;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__45580__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq48153){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq48153));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__44497__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__45579__auto__ = [];
var len__45572__auto___48162 = arguments.length;
var i__45573__auto___48163 = (0);
while(true){
if((i__45573__auto___48163 < len__45572__auto___48162)){
args__45579__auto__.push((arguments[i__45573__auto___48163]));

var G__48164 = (i__45573__auto___48163 + (1));
i__45573__auto___48163 = G__48164;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45580__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__48157_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__48158_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__48158_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq48159){
var G__48160 = cljs.core.first.call(null,seq48159);
var seq48159__$1 = cljs.core.next.call(null,seq48159);
var G__48161 = cljs.core.first.call(null,seq48159__$1);
var seq48159__$2 = cljs.core.next.call(null,seq48159__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__48160,G__48161,seq48159__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1484940689491