...
return [cljs.core.str((function (){var pred__46324 = cljs.core.instance_QMARK_;
var expr__46325 = reactive_val;
if(cljs.core.truth_(pred__46324.call(null,reagent.ratom.RAtom,expr__46325))){
return "ra";
} else {
if(cljs.core.truth_(pred__46324.call(null,reagent.ratom.RCursor,expr__46325))){
return "rc";
} else {
if(cljs.core.truth_(pred__46324.call(null,reagent.ratom.Reaction,expr__46325))){
return "rx";
} else {
if(cljs.core.truth_(pred__46324.call(null,reagent.ratom.Track,expr__46325))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1484940684573