...
var args47640 = [];
var len__45572__auto___47643 = arguments.length;
var i__45573__auto___47644 = (0);
while(true){
if((i__45573__auto___47644 < len__45572__auto___47643)){
args47640.push((arguments[i__45573__auto___47644]));

var G__47645 = (i__45573__auto___47644 + (1));
i__45573__auto___47644 = G__47645;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__44485__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__44485__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__44485__auto__)){
...
if(cljs.core.truth_((function (){var and__44485__auto__ = required_QMARK_;
if(cljs.core.truth_(and__44485__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__47650){
var map__47653 = p__47650;
...
var args = map__47653__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__47653__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__47653,map__47653__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__47647_SHARP_){
return item_renderer.call(null,p1__47647_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__47653,map__47653__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__47653,map__47653__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__47648_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__47648_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__47653,map__47653__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__47653,map__47653__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__47649_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__47649_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__47653,map__47653__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__45572__auto___47662 = arguments.length;
var i__45573__auto___47663 = (0);
while(true){
if((i__45573__auto___47663 < len__45572__auto___47662)){
args__45579__auto__.push((arguments[i__45573__auto___47663]));

var G__47664 = (i__45573__auto___47663 + (1));
i__45573__auto___47663 = G__47664;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__45580__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__47656){
...
var args = map__47657__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__47657,map__47657__$1,args){
return (function() { 
var G__47665__delegate = function (p__47659){
...
var G__47665 = function (var_args){
var p__47659 = null;
if (arguments.length > 0) {
var G__47666__i = 0, G__47666__a = new Array(arguments.length -  0);
while (G__47666__i < G__47666__a.length) {G__47666__a[G__47666__i] = arguments[G__47666__i + 0]; ++G__47666__i;}
  p__47659 = new cljs.core.IndexedSeq(G__47666__a,0);
} 
return G__47665__delegate.call(this,p__47659);};
G__47665.cljs$lang$maxFixedArity = 0;
G__47665.cljs$lang$applyTo = (function (arglist__47667){
var p__47659 = cljs.core.seq(arglist__47667);
return G__47665__delegate(p__47659);
});
G__47665.cljs$core$IFn$_invoke$arity$variadic = G__47665__delegate;
return G__47665;
})()
;
;})(map__47657,map__47657__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq47655){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq47655));
});


//# sourceMappingURL=selection_list.js.map?rel=1484940688345