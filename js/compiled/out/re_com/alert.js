...
var len__45572__auto___46906 = arguments.length;
var i__45573__auto___46907 = (0);
while(true){
if((i__45573__auto___46907 < len__45572__auto___46906)){
args__45579__auto__.push((arguments[i__45573__auto___46907]));

var G__46908 = (i__45573__auto___46907 + (1));
i__45573__auto___46907 = G__46908;
continue;
} else {
}
break;
...
return re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic(argseq__45580__auto__);
});

re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__46903){
var map__46904 = p__46903;
var map__46904__$1 = ((((!((map__46904 == null)))?((((map__46904.cljs$lang$protocol_mask$partition0$ & (64))) || (map__46904.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46904):map__46904);
var args = map__46904__$1;
var closeable_QMARK_ = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
var body = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var attr = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var heading = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var on_close = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var alert_type = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),new cljs.core.Keyword(null,"info","info",-317069002));
var style = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var id = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var padding = cljs.core.get.call(null,map__46904__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
...
var close_button = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.buttons.button,new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"zmdi created zmdi-hc-fw-rc zmdi-close",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"20px"], null)], null)], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__46904,map__46904__$1,args,closeable_QMARK_,body,attr,heading,on_close,alert_type,style,id,class$,padding){
return (function (event){
on_close.call(null,id);

return null;
});})(map__46904,map__46904__$1,args,closeable_QMARK_,body,attr,heading,on_close,alert_type,style,id,class$,padding))
...
re_com.alert.alert_box.cljs$lang$applyTo = (function (seq46902){
return re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq46902));
});
...
var args__45579__auto__ = [];
var len__45572__auto___46925 = arguments.length;
var i__45573__auto___46926 = (0);
while(true){
if((i__45573__auto___46926 < len__45572__auto___46925)){
args__45579__auto__.push((arguments[i__45573__auto___46926]));

var G__46927 = (i__45573__auto___46926 + (1));
i__45573__auto___46926 = G__46927;
continue;
} else {
}
break;
...
var argseq__45580__auto__ = ((((0) < args__45579__auto__.length))?(new cljs.core.IndexedSeq(args__45579__auto__.slice((0)),(0),null)):null);
return re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic(argseq__45580__auto__);
});

re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__46910){
...
var args = map__46911__$1;
var alerts = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"alerts","alerts",-2121664427));
var on_close = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var max_height = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var padding = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"padding","padding",1660304693),"4px");
var border_style = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"border-style","border-style",-485574304));
var class$ = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__46911__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.border,new cljs.core.Keyword(null,"padding","padding",1660304693),padding,new cljs.core.Keyword(null,"border","border",1444987323),border_style,new cljs.core.Keyword(null,"class","class",-2030961996),class$,new cljs.core.Keyword(null,"style","style",-496642736),style,new cljs.core.Keyword(null,"attr","attr",-604132353),attr,new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.scroller,new cljs.core.Keyword(null,"v-scroll","v-scroll",-1842185668),new cljs.core.Keyword(null,"auto","auto",-566279492),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-height","max-height",-612563804),max_height], null),new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.v_box,new cljs.core.Keyword(null,"size","size",1098693007),"auto",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__45277__auto__ = ((function (alerts__$1,map__46911,map__46911__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr){
return (function re_com$alert$iter__46913(s__46914){
return (new cljs.core.LazySeq(null,((function (alerts__$1,map__46911,map__46911__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr){
return (function (){
var s__46914__$1 = s__46914;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__46914__$1);
if(temp__4657__auto__){
var s__46914__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__46914__$2)){
var c__45275__auto__ = cljs.core.chunk_first.call(null,s__46914__$2);
var size__45276__auto__ = cljs.core.count.call(null,c__45275__auto__);
var b__46916 = cljs.core.chunk_buffer.call(null,size__45276__auto__);
if((function (){var i__46915 = (0);
while(true){
if((i__46915 < size__45276__auto__)){
var alert = cljs.core._nth.call(null,c__45275__auto__,i__46915);
cljs.core.chunk_append.call(null,b__46916,(function (){var map__46921 = alert;
var map__46921__$1 = ((((!((map__46921 == null)))?((((map__46921.cljs$lang$protocol_mask$partition0$ & (64))) || (map__46921.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46921):map__46921);
var id = cljs.core.get.call(null,map__46921__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.call(null,map__46921__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.call(null,map__46921__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.call(null,map__46921__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.call(null,map__46921__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.call(null,map__46921__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46916),re_com$alert$iter__46913.call(null,cljs.core.chunk_rest.call(null,s__46914__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46916),null);
}
} else {
var alert = cljs.core.first.call(null,s__46914__$2);
return cljs.core.cons.call(null,(function (){var map__46923 = alert;
...
var id = cljs.core.get.call(null,map__46923__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.call(null,map__46923__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.call(null,map__46923__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.call(null,map__46923__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.call(null,map__46923__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.call(null,map__46923__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.alert.alert_box,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),alert_type,new cljs.core.Keyword(null,"heading","heading",-1312171873),heading,new cljs.core.Keyword(null,"body","body",-2049205669),body,new cljs.core.Keyword(null,"padding","padding",1660304693),padding__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409),closeable_QMARK_,new cljs.core.Keyword(null,"on-close","on-close",-761178394),on_close], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),re_com$alert$iter__46913.call(null,cljs.core.rest.call(null,s__46914__$2)));
}
} else {
return null;
}
...
});})(alerts__$1,map__46911,map__46911__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr))
,null,null));
});})(alerts__$1,map__46911,map__46911__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr))
;
return iter__45277__auto__.call(null,alerts__$1);
})()], null)], null)], null)], null)], null);
});

re_com.alert.alert_list.cljs$lang$maxFixedArity = (0);

re_com.alert.alert_list.cljs$lang$applyTo = (function (seq46909){
return re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq46909));
});


//# sourceMappingURL=alert.js.map?rel=1484940686519