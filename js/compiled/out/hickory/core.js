...
var m__45161__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__45160__auto__)]);
if(!((m__45161__auto__ == null))){
return m__45161__auto__.call(null,this$);
} else {
var m__45161__auto____$1 = (hickory.core.as_hiccup["_"]);
...
var x__45160__auto__ = (((this$ == null))?null:this$);
var m__45161__auto__ = (hickory.core.as_hickory[goog.typeOf(x__45160__auto__)]);
if(!((m__45161__auto__ == null))){
return m__45161__auto__.call(null,this$);
} else {
var m__45161__auto____$1 = (hickory.core.as_hickory["_"]);
if(!((m__45161__auto____$1 == null))){
return m__45161__auto____$1.call(null,this$);
} else {
...
var pred__60364 = cljs.core._EQ_;
var expr__60365 = (this$["nodeType"]);
if(cljs.core.truth_(pred__60364.call(null,hickory.core.Attribute,expr__60365))){
...
var pred__60367 = cljs.core._EQ_;
var expr__60368 = (this$["nodeType"]);
if(cljs.core.truth_(pred__60367.call(null,hickory.core.Attribute,expr__60368))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__60367.call(null,hickory.core.Comment,expr__60368))){
...
if(cljs.core.truth_(pred__60367.call(null,hickory.core.Document,expr__60368))){
...
if(cljs.core.truth_(pred__60367.call(null,hickory.core.DocumentType,expr__60368))){
...
if(cljs.core.truth_(pred__60367.call(null,hickory.core.Element,expr__60368))){
...
if(cljs.core.truth_(pred__60367.call(null,hickory.core.Text,expr__60368))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__60368)].join('')));
}
}
}
}
...
var temp__4657__auto__ = cljs.core.second.call(null,(function (){var or__44497__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var temp__4657__auto___60370 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__4657__auto___60370)){
var title_el_60371 = temp__4657__auto___60370;
if(cljs.core.empty_QMARK_.call(null,(title_el_60371["text"]))){
hickory.core.remove_el.call(null,title_el_60371);
} else {
}
} else {
}
...
var or__44497__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);
if(cljs.core.truth_(or__44497__auto__)){
return or__44497__auto__;
} else {
...
//# sourceMappingURL=core.js.map?rel=1484941030067